...
/**
 * Build the application's normalized chat-completion result shape.
 *
 * This helper performs no network request and has no provider routing semantics;
 * it only normalizes official-provider responses into the internal result type.
 */
